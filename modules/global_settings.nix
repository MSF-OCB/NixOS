  ...
  settings.reverse_tunnel = {
    ...
    tunnels = {
      ...
      benuc005 = {
        ...
        public_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKBNqxdqs+rCmB3Rx2tMS0s5hKsxGytVHQxGn2GZdBns";
      };
      benuc006 = {
      ...
      benuc013 = {
        ...
        public_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPvJM3pmumWRZSNAjnGN1ZTE2sl1B514qlyKz3D7BorA";
      };
      benuc014 = {
