...

{
  ...
  settings.reverse_tunnel = {
    ...
    tunnels = {
      ...
      MumbaiPassive = {
        remote_forward_port = 7021;
        public_key = "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBLKygEiN52QCQh66Do/WNYNMFPTfXuEYMsqiKw/oACRPziMzS31/QaCc6/j+lN1S2L14b4X0XuYmbgTz27GhPbE=";
      };
      nixos-dev = {
      ...
      bevm004 = {
        ...
        public_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIJ8LlWYPDzrx1txIetQt/rlijtcHXs9ZLIoDy2RH+UK";
      };
    };
  };
}
